        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <button 
              ...
              className="text-gray-700 hover:text-glaz transition-colors duration-200 font-medium"
            >
              Accueil
            </button>
            <button 
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden lg:flex items-center space-x-4 text-sm text-gray-600">
              <div className="flex items-center space-x-1">
                ...
                <span>56 bis, rue de Clichy</span>
              </div>
              <div className="flex items-center space-x-1">
            ...
            <button 
              ...
              className="md:hidden p-2 text-gray-700 hover:text-glaz transition-colors"
            >
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-100">
            <nav className="flex flex-col space-y-3 pt-4">
              <button 
                onClick={() => scrollToSection('accueil')}
                className="text-left text-gray-700 hover:text-glaz transition-colors duration-200 font-medium py-2"
              >
                Accueil
              </button>
              <button 
